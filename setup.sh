...
REPO_CONFIG="\
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=hardknott;layer=meta \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=hardknott;layer=meta-poky \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=hardknott;layer=meta-yocto-bsp \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-oe \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-python \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-filesystems \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-networking \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-webserver \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-clang.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-virtualization.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-qa.git;branch=hardknott;layer=meta-qa-framework \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-qa.git;branch=hardknott;layer=meta-qa-testsuites \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgx.git;branch=hardknott;layer=qemu-bsp \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgx.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-perl \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-gnome \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-multimedia \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=hardknott;layer=meta-xfce \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-selinux.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-security.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cgl.git;branch=hardknott;layer=meta-cgl-common \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=hardknott;layer=meta-openstack \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgl.git;branch=hardknott \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-freescale.git;branch=hardknott \
MACHINE@ls1043ardb \
DISTRO@mvista-cgx \
