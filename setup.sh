...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgl.git;branch=gatesgarth \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-freescale.git;branch=gatesgarth \
MACHINE@ls1043ardb \
DISTRO@mvista-cgx \
